...
{
	partial class InsuranceCompaniesForm
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.Name = "InsuranceCompaniesForm";
			this.Text = "Страховые компании";
			this.Load += new System.EventHandler(this.InsuranceCompaniesForm_Load);
