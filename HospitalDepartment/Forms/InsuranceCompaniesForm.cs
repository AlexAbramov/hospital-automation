...
{
	public partial class InsuranceCompaniesForm : Form
	{
...
//		HandbookRecord SelectedHandbook { get { DataRow dr = SelectedRow; return dr!=null? new HandbookRecord(dr): null; } }
		...
		private void InsuranceCompaniesForm_Load(object sender, EventArgs e)
		{
		}
		...
		void LoadData()
		{
			...
			{
				dataAdapter = conn.CreateDataAdapter("select * from InsuranceCompanies");
