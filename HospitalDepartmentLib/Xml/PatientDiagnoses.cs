...
namespace HospitalDepartment
{
	...
	public class PatientDiagnoses
	{
		...
		#region Construction
		public static PatientDiagnoses Create(string xmlString)
		{
			if (String.IsNullOrEmpty(xmlString)) return new PatientDiagnoses();
			return (PatientDiagnoses)XmlUtils.DeserializeString(typeof(PatientDiagnoses), xmlString);
		}
