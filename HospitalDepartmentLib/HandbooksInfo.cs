...
namespace HospitalDepartment
{
	...
	public abstract class HandbooksInfo
	{
		...
		#region Construction
/*		public static HandbooksInfo Create(string xmlText)
		{
			if (xmlText == null || xmlText.Length == 0) return new HandbooksInfo();
			return (HandbooksInfo)XmlUtils.Deserialize(typeof(HandbooksInfo), xmlText);
		}
